...
//         const firstId = source.data.itemId as number;
//         const lastId = destination.data.itemId as number;
...
//   return (
//     <TableContainer component={Paper} className={`m-8 max-h-[600px]`}>
//       <Table stickyHeader>
//         <TableHead>
//           <TableRow>
...
// type AdminTableAddRowProps = {
//   format: {
//     key: string;
//     label: string;
//     input: 'text' | 'check' | 'picker' | 'color';
//     default?: any;
//     pickerData?: {
...
// const AdminTableAddRow = ({
//   format,
//   url,
//   setVisible,
//   noReorder,
//   addAsQuery,
// }: AdminTableAddRowProps) => {
...
const AdminTable = <T extends object>(props: AdminTableProps<T>) => {
