  ...
  return (
    <div className="relative inline-block w-[1000px]">
      <div className="flex">
        {/* Category List */}
        <div
          className="w-3/12 pr-2 border-r border-gray-300 overflow-x-hidden *:overflow-x-hidden max-h-[500px] flex flex-col">
        ...
        {/* Type List */}
        <div
          className="w-4/12 px-2 border-r border-gray-300 overflow-x-hidden *:overflow-x-hidden max-h-[500px] flex flex-col">
