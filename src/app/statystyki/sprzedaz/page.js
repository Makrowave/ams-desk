  ...
  return (
    <>
      ...
      <div className="bg-primary p-4 rounded-lg flex flex-col">
        <BarChartWrapper url={"SalesData/soldSum"} isStackedByDefault collapsible
      ...
      <div className={"bg-primary p-4 rounded-lg flex flex-col mt-8 items-center"}>
        <Collapsible className={"w-full"} title={"Sprzedane rowery ze względu na typ ramy"}>
      ...
      <div className={"bg-primary p-4 rounded-lg flex flex-col mt-8 items-center"}>
        <Collapsible className={"w-full"} title={"Sprzedane rowery ze względu na to czy są elektryczne"}>
          <div className="flex items-center w-full h-fit">
      ...
      <div className={"flex flex-wrap gap-8 mt-8"}>
        <div className={"bg-primary p-4 rounded-lg flex flex-col items-center min-w-[600px]"}>
          <BarChartWrapper url={"SalesData/getPlacesMedian"}
                           queryObject={{since: since, until: until}}
        ...
        <div className={"bg-primary p-4 rounded-lg flex flex-col items-center min-w-[600px]"}>
          <BarChartWrapper url={"SalesData/getPlacesAverage"}
                           queryObject={{since: since, until: until}}
          ...
          >
            <BarChart
              barLabel={({value}) => `${(value).toFixed(2)}zł`}
              height={400}
              sx={sxBar}
            />
          </BarChartWrapper>
        ...
        <div className={"bg-primary p-4 rounded-lg flex flex-col items-center min-w-[600px]"}>
          <BarChartWrapper url={"SalesData/getPlacesMedianDiscount"}
                           queryObject={{since: since, until: until}}
        ...
        <div className={"bg-primary p-4 rounded-lg flex flex-col items-center min-w-[600px]"}>
          <BarChartWrapper url={"SalesData/getPlacesSum"}
                           queryObject={{since: since, until: until}}
